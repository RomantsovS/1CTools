...
Функция Инициализировать()
	...
	//ПараметрыПодключения = ПолучитьПараметрыПодключения(1,,"cv8app12:1741", "1740", "ERP-TEST", Истина, , , "tcp://DB01/ERP", "ERP-TEST", "");
	//ПараметрыПодключения = ПолучитьПараметрыПодключения(1,,"CV8APP12:1741", "1740", "ERP-RKKT-TEST", Истина, , , "tcp://DB01/ERP", "Тест", "");
	ОбновитьИнформационнуюБазу(ПараметрыПодключения, Истина, Истина, Истина);
	//ПараметрыПодключения = ПолучитьПараметрыПодключения(1,,"cv8app12:1741", "1740", "ERP-DEV-Romantsov_s_test", Истина);
	//ОбновитьИнформационнуюБазу(ПараметрыПодключения, Истина, Истина);
